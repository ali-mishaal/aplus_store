...
export const MENUITEMS = [
    ...
    {
        menutitle:"Products",
        menucontent:"Dashboards,Products",
        Items:[
...

    {
        ...
        Items:[
            ...
            // { path: `${process.env.PUBLIC_URL}/app/kanban-board`,icon:Monitor,badge: "badge badge-primary",badgetxt:"latest", title: 'Kanban Board', type: 'link' },
