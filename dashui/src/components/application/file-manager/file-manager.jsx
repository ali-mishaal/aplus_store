...
import filesData from '../../../data/files-data/data'
    ...
    if(searchTerm == null)
      ...
      return(
        <li className="file-box" key={i}>
          <div className="file-top">{data.icon}<i className="fa fa-ellipsis-v f-14 ellips"></i></div>
  ...
  const onFileUpload = () => {
      ...
      if (selectedFile !== null) {
        myfiles.push({
          ...
          icon:<i className="fa fa-file-text-o txt-info"></i>
        })
        setMyFile(myfiles)
            ...
            <div className="file-sidebar">
              <Card>
                <CardBody>
                  <ul>
                    <li>
                      <div className="btn btn-primary"><Home />Home </div>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      <div className="btn btn-outline-primary"><Grid />Pricing plan</div>
                    </li>
                    <li>
                  ...
                  <div className="media">
                    ...
                    <div className="media-body text-right">
                      <Form className="d-inline-flex">
                        <div className="btn btn-primary" onClick={getFile}> <PlusSquare />Add New</div>
                        ...
                        <li className="folder-box">
                          <div className="media"><i className="fa fa-file-archive-o f-36 txt-warning"></i>
                            <div className="media-body ml-3">
                              <h6 className="mb-0">Endless admin</h6>
                              <p>204 files, 50mb</p>
                            </div>
                          </div>
                        </li>
