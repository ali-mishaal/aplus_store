                  ...
                  <CardBody>
                    <div className="email-app-sidebar left-bookmark">
                      ...
                      <Nav className="main-menu contact-options" role="tablist">
                        ...
                        <li>
                            <button className="btn btn-category" onClick={categoryToggle}><span className="title"> + Add Category</span></button>
                            <Modal isOpen={categoryModal} toggle={categoryToggle}>
                            <ModalHeader toggle={categoryToggle}>Add Category</ModalHeader>
                              <ModalBody>
                        ...
                        <NavItem><a href="#javascript"  className={activeTab === '2' ? 'active' : ''} onClick={() => setActiveTab('2')}><span className="title"> Organization</span></a></NavItem>
                        <NavItem><a href="#javascript"  className={activeTab === '3' ? 'active' : ''} onClick={() => setActiveTab('3')}><span className="title">Follow up</span></a></NavItem>
                        <NavItem><a href="#javascript"  className={activeTab === '4' ? 'active' : ''} onClick={() => setActiveTab('4')}><span className="title">Favorites</span></a></NavItem>
                  ...
                  <div className="pl-0">
                    <TabContent activeTab={activeTab}>
                                      ...
                                      <div className="profile-mail">
                                        ...
                                        <div className="email-general">
                                          ...
                                          <ul>
                                            ...
                                            <li>Email Address <span className="font-primary email_add_0">{`${selectedUser.name}@gmail.com`} </span></li>
                                          </ul>
                                        </div>
                                      </div>
                                      :
                      ...
                      <TabPane tabId="2">
                        <Card className="mb-0">
                          <CardHeader className="d-flex">
                            <h5>Organization</h5><span className="f-14 pull-right mt-0">10 Contacts</span>
                          </CardHeader>
                          <CardBody className="p-0">
                              ...
                              <Col xl="4 xl-50" md="5">
                                <Nav className="flex-column nav-pills" id="v-pills-tab1" role="tablist" aria-orientation="vertical">
                                  <NavItem id="myTab" role="tablist">
                                    <a  href="#javaScript" className={orgactiveTab === '1' ? 'active' : ''} onClick={() => setorgActiveTab('1')}>
                                      <div className="media">
                                  ...
                                  <NavItem id="myTab" role="tablist">
                                    <a  href="#javaScript" className={orgactiveTab === '2' ? 'active' : ''} onClick={() => setorgActiveTab('2')}>
                                ...
                                <TabContent activeTab={orgactiveTab}>
                                  <TabPane tabId="1">
                                    <div className="profile-mail">
                                      ...
                                      <div className="email-general">
                                        <h6>General</h6>
                                        <p>Email Address: <span className="font-primary email_add_5">markjecno@gmail.com</span></p>
                                  ...
                                  <TabPane tabId="2">
                                    <div className="profile-mail">
                                      ...
                                      <div className="email-general">
                                        <h6>General</h6>
                                        <p>Email Address: <span className="font-primary email_add_6">jasonb@gmail.com</span></p>
                                        <div className="gender">
                                          <h6>Personal</h6>
                                          <p>Gender: <span>Male</span></p>
                                        </div>
                                  ...
                                  <TabPane tabId="3">
                                    <div className="profile-mail">
                                      ...
                                      <div className="email-general">
                                        <h6>General</h6>
                                        <p>Email Address: <span className="font-primary email_add_7">barnes@gmail.com</span></p>
                                        <div className="gender">
                                          <h6>Personal</h6>
                                  ...
                                  <TabPane tabId="4">
                                    <div className="profile-mail">
                                      ...
                                      <div className="email-general">
                                        <h6>General</h6>
                                        <p>Email Address: <span className="font-primary email_add_8">andrewj@gmail.com</span></p>
                                        <div className="gender">
                                          <h6>Personal</h6>
                                          <p>Gender: <span>Female</span></p>
                                        </div>
                      ...
                      <TabPane tabId="3">
                        <Card className="mb-0">
                          <CardHeader className="d-flex">
                            <h5>Follow Up</h5><span className="f-14 pull-right mt-0">10 Contacts</span>
                          </CardHeader>
                          <CardBody>
                            <p>No Data Found </p>
                          </CardBody>
                      ...
                      <TabPane tabId="4">
                        <Card className="mb-0">
                          <CardHeader className="d-flex">
                            <h5>Favorites</h5><span className="f-14 pull-right mt-0">10 Contacts</span>
                          </CardHeader>
                          <CardBody>
                            <p>No Data Found </p>
                          </CardBody>
                      ...
                      <div id="right-history" className="history">
                        <div className="modal-header p-l-20 p-r-20">
                          <h6 className="modal-title w-100">Contact History
