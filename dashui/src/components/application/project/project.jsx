              ...
              <Row>
                ...
                <Col sm="6">
                  <div className="text-right">
                    ...
                    <Link className="btn btn-primary" style={{ color: 'white' }} to={`${process.env.PUBLIC_URL}/app/project/new-project`}> <PlusCircle />Create New Project</Link>
                  </div>
                </Col>
              </Row>
            </Card>
                      ...
                      {allProject.map((item, i) =>
                        <Col sm="4" className="mt-4" key={i}>
                          <div className="project-box">
                            ...
                            <h6>{item.title}</h6>
                            <div className="media">
                              <img className="img-20 mr-1 rounded-circle" src={item.img} alt="" />
                            ...
                            <div className="customers">
                              <ul>
                                <li className="d-inline-block"><img className="img-30 rounded-circle" src={item.customers_img1} alt="" /></li>
                                <li className="d-inline-block"><img className="img-30 rounded-circle" src={item.customers_img2} alt="" /></li>
                                <li className="d-inline-block"><img className="img-30 rounded-circle" src={item.customers_img3} alt="" /></li>
