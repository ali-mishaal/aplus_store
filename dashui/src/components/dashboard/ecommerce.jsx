                      ...
                      <CardHeader className="card-no-border">
                        ...
                        <div className="media">
                          <div className="media-body">
                            <p><span className="f-w-500 font-roboto">Today Total sale</span><span className="f-w-700 font-primary ml-2">89.21%</span></p>
                  ...
                  <Col xl="6" className="box-col-6" md="6">
                    <Card className="o-hidden">
                      <CardHeader className="card-no-border">
                        ...
                        <div className="media">
                          <div className="media-body">
                            <p><span className="f-w-500 font-roboto">Today Total visits</span><span className="f-w-700 font-primary ml-2">35.00%</span></p>
                    ...
                    <Card className="o-hidden">
                      <CardBody>
                        <div className="ecommerce-widgets media">
                          <div className="media-body">
                            <p className="f-w-500 font-roboto">Our Sale Value<span className="badge pill-badge-primary ml-3">New</span></p>
                  ...
                  <Col xl="6" lg="12" md="6" className="box-col-6">
                    <Card className="o-hidden">
                      <CardBody>
                        <div className="media">
                          <div className="media-body">
                            <p className="f-w-500 font-roboto">Today Stock value<span className="badge pill-badge-primary ml-3">Hot</span></p>
              ...
              <Col xl="5 xl-50" className="box-col-12">
                <Card className="o-hidden dash-chart">
                  <CardHeader className="card-no-border">
                    ...
                    <div className="media">
                      <div className="media-body">
                        <p><span className="f-w-500 font-roboto">Total Profit</span><span className="font-primary f-w-700 ml-2">99.00%</span></p>
                        <h4 className="f-w-500 mb-0 f-26">$<span className="counter"><CountUp  end={300056} /></span></h4>
                      </div>
                    </div>
                  </CardHeader>
                            ...
                            <tr>
                              <td>
                                <div className="media"><img className="img-fluid m-r-15 rounded-circle" src={require("../../assets/images/dashboard-2/product-1.png")} alt=""/>
                                  <div className="media-body"><span>Hike Shoes</span>
                            ...
                            <tr>
                              <td>
                                <div className="media"><img className="img-fluid m-r-15 rounded-circle" src={require("../../assets/images/dashboard-2/product-3.png")} alt=""/>
                                  <div className="media-body"><span>Tree Pot</span>
                            ...
                            <tr>
                              <td>
                                <div className="media"><img className="img-fluid m-r-15 rounded-circle" src={require("../../assets/images/dashboard-2/product-5.png")} alt=""/>
                                  <div className="media-body"><span>Wtach</span>
                            ...
                            <tr>
                              <td>
                                <div className="media"><img className="img-fluid m-r-15 rounded-circle" src={require("../../assets/images/dashboard-2/product-6.png")} alt=""/>
                                  <div className="media-body"><span>T-shirt</span>
                      ...
                      <div className="rate-card col-xl-12">
                        ...
                        <div className="goal-end-point">
                          <ul>
                            ...
                            <li>
                              <h6 className="mb-2 f-w-400">Total Goal</h6>
                      ...
                      <ul className="col-xl-12">
                        <li>
                          <div className="goal-detail">
                            <h6> <span className="font-primary">Goal Archive : </span>$91,000.000</h6>
                        ...
                        <li>
                          <div className="btn-download btn btn-gradient f-w-500">Download details</div>
                        </li>
                      </ul>
                    </div>
                  </CardBody>
                                  ...
                                  <div className="col-xl-4 col-md-6">
                                    <div className="d-flex">
                                      <div className="left-content">
                                        ...
                                        <h4 className="f-w-600">Best Selling Product</h4><span className="badge badge-white badge-pill">78% offer</span><span className="badge badge-dotted badge-pill ml-2">Coupon Code : 12345</span>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="col-xl-4 col-md-6">
                                    <div className="d-flex">
                                      <div className="left-content">
                                        ...
                                        <h4 className="f-w-600">Best Selling Product</h4><span className="badge badge-white badge-pill">50% offer</span><span className="badge badge-dotted badge-pill ml-2">Coupon Code : 21546</span>
                                      </div>
                                    </div>
                                  </div>
                                  <div className="col-xl-4 col-md-12">
                                  ...
                                  <tr>
                                    <td>
                                      <div className="d-inline-block align-middle"><img className="img-40 m-r-15 rounded-circle align-top" src={require("../../assets/images/avtar/7.jpg")} alt=""/>
                                        ...
                                        <div className="d-inline-block"><span>John keter</span>
                                  ...
                                  <tr>
                                    <td>
                                      <div className="d-inline-block align-middle"><img className="img-40 m-r-15 rounded-circle align-top" src={require("../../assets/images/avtar/4.jpg")} alt=""/>
                                        <div className="status-circle bg-primary"></div>
                                        <div className="d-inline-block"><span>Herry Venter</span>
                                  ...
                                  <tr>
                                    <td>
                                      <div className="d-inline-block align-middle"><img className="img-40 m-r-15 rounded-circle align-top" src={require("../../assets/images/avtar/16.jpg")} alt=""/>
                                        <div className="status-circle bg-primary"></div>
                                        <div className="d-inline-block"><span>loain deo</span>
                                          <p className="font-roboto">2020</p>
                                        </div>
                                      </div>
                                    </td>
                                  ...
                                  <tr>
                                    <td>
                                      <div className="d-inline-block align-middle"><img className="img-40 m-r-15 rounded-circle align-top" src={require("../../assets/images/avtar/11.jpg")} alt=""/>
                                        <div className="status-circle bg-primary"></div>
                                        <div className="d-inline-block"><span>Horen Hors</span>
                                          <p className="font-roboto">2020</p>
                                        </div>
                                      </div>
                                    </td>
                                    ...
                                    <td className="text-right"> <i className="fa fa-check-circle"></i>In process</td>
                                  </tr>
                                  <tr>
                                    <td>
                                      <div className="d-inline-block align-middle"><img className="img-40 m-r-15 rounded-circle align-top" src={require("../../assets/images/avtar/3.jpg")} alt=""/>
                                        <div className="status-circle bg-primary"></div>
                                        <div className="d-inline-block"><span>fenter Jessy</span>
