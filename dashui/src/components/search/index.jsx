      ...
      <Container fluid={true} className="search-page">
        <Row>
          <Col sm="12">
            <Card>
              <CardHeader>
                <Form className="search-form p-10">
                    ...
                    <Row>
                      <Col xl="6">
                        ...
                        <div className="info-block">
                          <h6>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h6><a href="https://themeforest.net/user/pixelstrap">Cubaeducation.info/</a>
                        ...
                        <div className="info-block">
                          <h6>Proin eleifend metus vel erat faucibus, ut bibendum nulla iaculis.</h6><a href="https://themeforest.net/user/pixelstrap">Cubaeducation.info/</a>
                          <p>cuba introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.</p>
                          <div className="star-ratings">
                            <ul className="search-info">
                              <li>4.5 stars</li>
                        ...
                        <div className="info-block">
                          <h6>Fusce rutrum elit aliquet nisi malesuada cursus.</h6><a href="https://themeforest.net/user/pixelstrap">Cubaeducation.info/</a>
                          <p>cuba introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.</p>
                          <div className="star-ratings">
                            <ul className="search-info">
                        ...
                        <div className="info-block">
                          <h6>Morbi feugiat mauris vel semper fringilla.</h6><a href="https://themeforest.net/user/pixelstrap">Cubaeducation.info/</a>
                          <p>cuba introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.</p>
                          <div className="star-ratings">
                            <ul className="search-info">
                              <li><i className="icofont icofont-ui-rating"></i><i className="icofont icofont-ui-rating"></i><i className="icofont icofont-ui-rating"></i><i className="icofont icofont-ui-rating"></i><i className="icofont icofont-ui-rating"></i></li>
                    ...
                    <Row>
                      <Col xl="6">
                        ...
                        <Media className="info-block">
                          ...
                          <Media body>
                            <h6>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h6><a href="https://themeforest.net/user/pixelstrap/portfolio">Cubaeducation.info/</a>
                            <p>cuba introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.</p>
                            <div className="star-ratings">
                              <ul className="search-info">
                                <li>5 stars</li>
                        ...
                        <Media className="info-block">
                          ...
                          <Media body>
                            <h6>Morbi eget quam et purus commodo dapibus.</h6><a href="https://themeforest.net/user/pixelstrap/portfolio">Cubaeducation.info/</a>
                            <p>cuba introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.</p>
                            <div className="star-ratings">
                              <ul className="search-info">
                                <li>5 stars</li>
                        ...
                        <Media className="info-block">
                          ...
                          <Media body>
                            <h6>Etiam eget ligula at ante eleifend rutrum.</h6><a href="https://themeforest.net/user/pixelstrap/portfolio">Cubaeducation.info/</a>
                            <p>cuba introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.</p>
                            <div className="star-ratings">
                              <ul className="search-info">
                                <li>5 stars</li>
                        ...
                        <Media className="info-block">
                          ...
                          <Media body>
                            <h6>Lorem Ipsum is simply dummy text of the printing.</h6><a href="https://themeforest.net/user/pixelstrap/portfolio">Cubaeducation.info/</a>
                            <p>cuba introduces a ielts coaching, toefl coaching, gre coaching, gmat coaching, sat coaching in surat.</p>
                            <div className="star-ratings">
                              <ul className="search-info">
                                <li>5 stars</li>
